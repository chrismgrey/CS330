...
void SceneManager::LoadSceneTextures()
{
	...
	// loading all textures from 5-2_Assignment/Textures folder I created
	// I did this since we submit the assignment folder, and the textures folder was in the parent CS330Content/Utilities/Textures folder
	...
	CreateGLTexture("Textures/tilesf2.jpg", "tiles");
	CreateGLTexture("Textures/stainedglass.jpg", "glass");
	CreateGLTexture("Textures/circular-brushed-gold-texture.jpg", "gold");
...
void SceneManager::RenderScene()
{
	...
	// load texture for box, the plank
...
SetTextureUVScale(1.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, 4.50f, 2.0f);
