...
namespace
{
	...
	// multiplier used to control how fast the camera moved based on scroll input
...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// this callback is used to handle mouse scroll input for adjusting camera movement speed
...
void ViewManager::Mouse_Scroll_Wheel_Callback(GLFWwindow* window, double xOffset, double yOffset)
{
	...
	// added CMD output so confirm funcitonality of scroll
