...
void SceneManager::DefineObjectMaterials()
{
	...
	whiteMaterial.ambientStrength = 0.3f;
	whiteMaterial.diffuseColor = glm::vec3(1.0f, 1.0f, 1.0f);
	whiteMaterial.specularColor = glm::vec3(1.0f, 1.0f, 1.0f);
...
void SceneManager::SetupSceneLights()
{
	...
	// light 1, main warm key light
	m_pShaderManager->setVec3Value("lightSources[0].position", 6.0f, 6.0f, 8.0f);
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.25f, 0.22f, 0.18f);
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 1.0f, 0.85f, 0.70f);
	...
	// liht 2, colored fill light
	m_pShaderManager->setVec3Value("lightSources[1].position", -6.0f, 3.0f, 6.0f);
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.05f, 0.0f, 0.0f);
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 0.9f, 0.1f, 0.1f);
	m_pShaderManager->setVec3Value("lightSources[1].specularColor", 0.9f, 0.3f, 0.3f);
	...
	// light 3, soft overhead
	m_pShaderManager->setVec3Value("lightSources[2].position", 0.0f, 10.0f, 5.0f);
	m_pShaderManager->setVec3Value("lightSources[2].ambientColor", 0.15f, 0.15f, 0.15f);
...
void SceneManager::RenderScene()
{
	...
	SetShaderColor(1, 5, 0, 1);

	// draw the mesh with transformation values - this plane is used for the base
	// apply white material properties to help with lighting
	...
	// set the active color values in the shader (RGBA)
	SetShaderColor(0.75f, 0.1f, 1.0f, 1.0f);
	// apply white material properties to help with lighting
	SetShaderMaterial("white");
	...
	// set the active color values in the shader (RGBA)
	// Apply a strong green tint to this object.
	// The lighting will interact with this tint to give the shape a bright green tone.
	SetShaderColor(0.1f, 1.0f, 0.1f, 1.0f);
	// apply white material properties to help with lighting
	SetShaderMaterial("white");
	...
	// set the active color values in the shader (RGBA)
	// Apply a strong blue tint to this object.
	// This color multiplies with the lighting to produce a vivid blue highlight.
	SetShaderColor(0.0f, 0.2f, 1.0f, 1.0f);
	// apply white material properties to help with lighting
	SetShaderMaterial("white");
	...
	// set the active color values in the shader (RGBA)
	// Apply a strong red tint to this object.
	// This creates a bold red appearance while still allowing lighting to shape the surface.
	SetShaderColor(1.0f, 0.1f, 0.1f, 1.0f);
	// apply white material properties to help with lighting
	SetShaderMaterial("white");
